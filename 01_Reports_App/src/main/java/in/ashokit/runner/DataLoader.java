...
//Medical Plan
			...
			c11.setCitigenName("Moris");
			c11.setGender("Male");
			c11.setPlanName("Employment");
			c11.setPlanStatus("Denied");
			c11.setDenielReason("Property Income");
			
			
			CitizenPlan c12=new CitizenPlan();
			c12.setCitigenName("Neel");
